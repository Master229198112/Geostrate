      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/40 backdrop-blur-sm" onClick={onClose}>
        <div className="bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-600 rounded-lg shadow-2xl max-w-md w-full p-8" onClick={e => e.stopPropagation()}>
          ...
          {showLoginPrompt && !user && (
            <div className="mb-4 p-3 bg-amber-50 dark:bg-amber-500/10 border border-amber-200 dark:border-amber-500/20 text-amber-700 dark:text-amber-400 text-sm rounded-sm">
              Please <strong>login or register</strong> first, then purchase a subscription plan to download reports. Close this modal and click the <strong>Login</strong> button in the header.
            </div>
          )}
